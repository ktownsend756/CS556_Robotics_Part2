...
#define kp 100 //Tune Kp here
#define kd 20 //Tune Kd here
#define ki 2 //Tune Ki here
#define clamp_i 15 //Tune ki integral clamp here
...
double PDout=0, PIDout=0; //Output variables for your controllers
...
void loop() {
  ...
  */
  ...
  int leftSpeed = -PIDout;
  int rightSpeed = PIDout;
  motors.setSpeeds(leftSpeed, rightSpeed);
